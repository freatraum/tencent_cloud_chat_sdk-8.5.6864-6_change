...
import 'package:tencent_cloud_chat_sdk/models/v2_tim_message_reaction.dart'
    if (dart.library.html) 'package:tencent_cloud_chat_sdk/web/compatible_models/v2_tim_message_reaction.dart';
...
class V2TimMessageReactionResult {
  ...
  V2TimMessageReactionResult.fromJson(Map json) {
    ...
    resultCode = json['message_reaction_result_code'] ?? -1;
    resultInfo = json['message_reaction_result_info'] ?? "";
    messageID = json['message_reaction_result_msg_id'] ?? "";
    if (json['message_reaction_result_reaction_list'] != null) {
      reactionList = List.empty(growable: true);
      json['message_reaction_result_reaction_list'].forEach((v) {
